...
\restrict M70S4Tf7vwJAsRIiHAJXXGXh6ExhaauWaCEzJeVGmRBotDruFQpuWIgvKMj4Dd8
...
CREATE TABLE public.customer_activity_details (
    ...
    logged_by_user character varying(140),
    erpnext_name character varying(140)
);
...
CREATE TABLE public.quotations (
    quotation_id character varying(140) NOT NULL,
    customer_name character varying(255),
    quotation_to character varying(50),
    transaction_date date,
    status character varying(50),
    grand_total numeric(14,2),
    opportunity_id character varying(140),
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
);
...
--
-- Name: customer_activity_details customer_activity_details_erpnext_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_activity_details
    ADD CONSTRAINT customer_activity_details_erpnext_name_key UNIQUE (erpnext_name);
...
--
-- Name: customer_contacts customer_contacts_erpnext_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_contacts
    ADD CONSTRAINT customer_contacts_erpnext_name_key UNIQUE (erpnext_name);
...
--
-- Name: customer_monthly_devices customer_monthly_devices_erpnext_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_monthly_devices
    ADD CONSTRAINT customer_monthly_devices_erpnext_name_key UNIQUE (erpnext_name);
...
--
-- Name: customer_project_tasks customer_project_tasks_erpnext_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_project_tasks
    ADD CONSTRAINT customer_project_tasks_erpnext_name_key UNIQUE (erpnext_name);
...
--
-- Name: customer_sample_testing customer_sample_testing_erpnext_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_sample_testing
    ADD CONSTRAINT customer_sample_testing_erpnext_name_key UNIQUE (erpnext_name);
...
--
-- Name: imei_details imei_details_erpnext_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.imei_details
    ADD CONSTRAINT imei_details_erpnext_name_key UNIQUE (erpnext_name);
...
--
-- Name: logistics_comments logistics_comments_erpnext_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.logistics_comments
    ADD CONSTRAINT logistics_comments_erpnext_name_key UNIQUE (erpnext_name);
...
--
-- Name: logistics_entry_items logistics_entry_items_erpnext_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.logistics_entry_items
    ADD CONSTRAINT logistics_entry_items_erpnext_name_key UNIQUE (erpnext_name);
...
--
-- Name: idx_activity_log_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_activity_log_time ON public.activity_log USING btree (logged_at);
...
\unrestrict M70S4Tf7vwJAsRIiHAJXXGXh6ExhaauWaCEzJeVGmRBotDruFQpuWIgvKMj4Dd8
